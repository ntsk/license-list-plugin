...
class ArtifactManagement(
    ...
    companion object {
         ...
         */
        val CommonConfigurationNames: Set<String> =
            setOf(
                // runtimeOnly
                "compileOnly",
                "implementation",
    ...
    fun analyze(
            ...
            scopedConfigurations.mapValues { (scope, configuration) ->
                configuration
                    .let {
                        ...
                        val newResolvedIdentifiers =
                            configuration.toResolvedModuleIdentifiers().filterNot { id ->
            ...
            localFileMap.values
                ...
                .groupBy { file ->
                    ...
                    files.mapNotNull { file ->
                        ...
                        val metadata =
                            ResolvedLocalFileMetadata(
                                displayName = file.nameWithoutExtension,
                                licenses =
                                    licenseCandidates.mapIndexed { i, path ->
                                        LicenseSeed(
        ...
        return (
            resolveResults.resolvedComponents.flatMap { result ->
    ...
    internal fun Configuration.toResolvedModuleIdentifiers(): List<ResolvedModuleIdentifier> =
        lenientConfiguration()
            ?.run {
                artifacts
                    .filter { it.type == "aar" || it.type == "jar" }
                    .let {
